<template>
    <main id="main" class="site-main">
			<section class="site-banner layout-02 bg-white" style="background-image: url(images/workspace/banne.png);">
                <div class="container">
                    <div class="site-banner__content">
                         <p>Getting a home is a collborative process</p>
                        <h3 class="site-banner__title">Let's find one together</h3>
            ...
            <section class="features layout-02">
                <div class="container">
                     <div class="title-wrap align-center">
                        <h2>How it works</h2>
                        <p>We offer you exciting property deals at the cheapest rates.</p>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="features-item">
                                <img src="images/workspace/features-01.png" alt="">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="features-item">
                                <img src="images/workspace/features-02.png" alt="">
                                <div class="features-content">
                                    <h2>Love it</h2>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="features-item">
                                <img src="images/workspace/features-03.png" alt="">
                                <div class="features-content">
                                    <h2>Book it</h2>
            ...
            <section class="testimonial-wrap d-none">
                <div class="container">
                    <div class="title-wrap align-center">
            ...
            <section class="banner-wrap">
                <div class="container pt-5">
                    <div class="banner-inner" style="background-image: url(images/workspace/desk-home.png);">
                        <h2 class="text-white">List your property with us</h2>
                        <p class="text-white">It's easy to list, simple to manage and, best of all, free to list!</p>
